...
<table class="table">
  ...
  <input name="idProduct" type="text" value="<?php echo $GLOBALS['idProduct']; ?>" hidden=""  /><input name="quantity" id="quantity" value="<?php echo $GLOBALS['quantity']; ?>" hidden="" />
  <input class="btn btn-lg btn-success" style="float: right;" type="submit" value="Pay Now"/>
</form>
